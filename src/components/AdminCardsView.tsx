            ...
            return (
              <div
                ...
                style={{
                  ...
                  backgroundColor: "var(--paper-card)",
                  borderRadius: "4px",
                  border: `1px solid ${isRevoked ? "rgba(220, 38, 38, 0.3)" : "var(--line-strong)"}`,
                  boxShadow: "var(--shadow)",
                  display: "flex",
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  <span
                    style={{
                      ...
                      backgroundColor: isActive ? "rgba(4, 106, 56, 0.08)" : isRevoked ? "rgba(220, 38, 38, 0.08)" : "rgba(232, 87, 26, 0.08)",
                      color: isActive ? "var(--green)" : isRevoked ? "var(--red)" : "var(--saffron)",
                      border: `1px solid ${isActive ? "rgba(4, 106, 56, 0.25)" : isRevoked ? "rgba(220, 38, 38, 0.25)" : "rgba(232, 87, 26, 0.25)"}`,
                    }}
                  >
                    {card.status}
                  </span>
