    ...
    <div style={{ display: "grid", gap: "24px" }}>
      ...
      >
        <div style={{ position: "relative", flex: 1, minWidth: "260px" }}>
          <Search size={16} style={{ position: "absolute", left: "14px", top: "12px", color: "var(--muted)" }} />
          <input
            type="text"
            placeholder="Search action (e.g. SUBMISSION_EXPORT_GENERATED, MEMBER_APPROVED)"
            value={search}
            ...
            <tbody>
              {filtered.map((log) => (
                <tr key={log.id} style={{ borderBottom: "1px solid var(--line)" }}>
                  <td style={{ padding: "12px 18px", color: "var(--muted)", whiteSpace: "nowrap" }}>
                  ...
                  <td style={{ padding: "12px 18px", fontSize: "12px", color: "var(--muted)" }}>
