...
export default function CinematicSection({ headline, desc, align = "left", borderAccent = true }: CinematicSectionProps) {
  ...
  return (
    <section className="relative min-h-[70vh] flex flex-col justify-center py-20 bg-off-white">
      <div className={`max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col ${alignClass[align]}`}>
        ...
        >
          <p className="font-english text-[clamp(1.125rem,2vw,1.5rem)] text-black/75 leading-relaxed max-w-2xl font-light">
            {desc}
          </p>
        </motion.div>
      </div>
