      ...
      <PageTransition>
        <main className="bg-black min-h-screen pt-24 pb-24">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <p className="text-xl leading-relaxed text-white/70 font-medium mb-12 font-body">
                {t("content")}
              </p>

              {sections.map((key, index) => (
                <div key={key} className="border-l-2 border-white/10 pl-6 sm:pl-8 py-2">
                  <span className="font-mono text-xs text-white/40 tracking-widest font-bold block mb-3">CLAUSE {index + 1}</span>
