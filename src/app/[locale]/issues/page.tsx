        ...
        <main className="bg-off-white min-h-screen text-black pt-24 sm:pt-32 pb-24">
          ...
          <section className="px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto mb-20 sm:mb-32">
            <motion.div
              ...
              className="max-w-4xl"
            >
              <h1 className="font-hindi text-[clamp(4rem,10vw,8rem)] leading-[0.85] text-black font-bold mb-6 tracking-tight uppercase">
                {t("Hero.headline")}
              </h1>
              <p className="font-body text-xl sm:text-2xl text-black/60 max-w-2xl border-l-4 border-red pl-6 py-2 leading-relaxed">
                {t("Hero.subheadline")}
              </p>
            </motion.div>
          </section>
              ...
              {categories.map((cat, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-white border border-black/10 rounded-2xl p-6 flex flex-col justify-between group hover:bg-black/10 hover:scale-105 transition-all duration-300"
                  >
                    <div>
                      <div className="w-14 h-14 bg-white border border-black/10 rounded-2xl flex items-center justify-center mb-6 text-black/60 group-hover:text-red transition-colors duration-300">
                        <Icon size={28} strokeWidth={1.5} />
                      </div>
                      
                      <h3 className="font-hindi text-3xl font-bold text-black mb-3">
