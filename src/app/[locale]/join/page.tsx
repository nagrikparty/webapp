        ...
        <main className="bg-charcoal min-h-screen">
          ...
          <section className="px-4 sm:px-6 lg:px-8 pb-32 max-w-4xl mx-auto relative z-10">
            <motion.div
              ...
              className="bg-off-white rounded-3xl p-6 sm:p-10 shadow-2xl relative overflow-hidden border border-white/10"
            >
              <AnimatePresence mode="wait">
                {isSuccess ? (
                  ...
                  >
                    ...
                    {/* Progress Bar */}
                    <div className="w-full bg-black/5 h-1.5 rounded-full mb-10 overflow-hidden">
                      <div 
                        ...
                        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                              ...
                              <select required className="civic-select w-full bg-white/50 border border-black/10 rounded-xl px-4 py-3.5 font-body text-sm focus:outline-none focus:border-black/30 transition-colors" value={formData.state} onChange={e => setFormData({...formData, state: e.target.value})}>
                            ...
                            <div className="space-y-2">
                              ...
                              <select required disabled={!formData.state || vidhanSabhas.length === 0} className="civic-select w-full bg-white/50 border border-black/10 rounded-xl px-4 py-3.5 font-body text-sm focus:outline-none focus:border-black/30 transition-colors disabled:opacity-50" value={formData.vidhan_sabha} onChange={e => setFormData({...formData, vidhan_sabha: e.target.value})}>
                            ...
                            <div className="space-y-2">
                              ...
                              {wards.length > 0 ? (
                                <select required className="civic-select w-full bg-white/50 border border-black/10 rounded-xl px-4 py-3.5 font-body text-sm focus:outline-none focus:border-black/30 transition-colors" value={formData.ward} onChange={e => setFormData({...formData, ward: e.target.value})}>
                        ...
                        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-8">
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                              {skillsList.map(skill => (
                                <label key={skill} className={`flex items-center p-3 border rounded-xl cursor-pointer transition-colors ${selectedSkills.includes(skill) ? 'border-red/50 bg-red/5' : 'border-black/10 bg-white hover:border-black/20'}`}>
                                  <input type="checkbox" className="hidden" checked={selectedSkills.includes(skill)} onChange={() => toggleSkill(skill)} />
                                  <div className={`w-4 h-4 rounded border flex items-center justify-center mr-3 transition-colors ${selectedSkills.includes(skill) ? 'bg-red border-red' : 'border-black/20'}`}>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                              ...
                              <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-black/10 border-dashed rounded-xl cursor-pointer bg-white/30 hover:bg-black/5 transition-colors group">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div className="space-y-2">
                              ...
                              <select className="civic-select w-full bg-white/50 border border-black/10 rounded-xl px-4 py-3.5 font-body text-sm focus:outline-none focus:border-black/30 transition-colors" value={formData.referral_source} onChange={e => setFormData({...formData, referral_source: e.target.value})}>
