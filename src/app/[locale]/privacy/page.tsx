      ...
      <PageTransition>
        <main className="bg-off-white min-h-screen pt-32 pb-24">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <p className="text-xl leading-relaxed text-black/80 font-medium mb-12 font-body bg-red/5 p-6 rounded-xl border border-red/10">
                {t("content")}
              </p>

              {sections.map((key, index) => (
                <div key={key} className="border-l-2 border-black/10 pl-6 sm:pl-8 py-2">
                  <span className="font-mono text-xs text-black/40 tracking-widest font-bold block mb-3">SECTION {index + 1}</span>
