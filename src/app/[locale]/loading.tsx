export default function Loading() {
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center transition-colors duration-300" role="status" aria-label="Loading">
      <div className="flex flex-col items-center gap-6">
        <div className="w-12 h-12 border-4 border-black/10 dark:border-white/10 border-t-red rounded-full animate-spin">
