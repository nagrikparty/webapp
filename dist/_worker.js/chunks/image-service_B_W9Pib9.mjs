...
import { b as baseService, i as isESMImportedImage } from './generic_DQAYNk7A.mjs';
import { aq as commonjsGlobal } from './astro/server_Cvbbl0_e.mjs';
import require$$0 from 'node:crypto';
import { a as matchHostname, m as matchPattern } from './remote_BhEScGb5.mjs';
...
const service = {
  ...
  getURL: (options, imageConfig) => {
    ...
    const imageEndpoint = joinPaths(
      ...
      Object.assign(__vite_import_meta_env__, {}).BASE_URL,
      "/cdn-cgi/image",
      resizingParams.join(","),
      imageSource
    );
