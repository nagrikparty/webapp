  ...
  `);
      ...
      async function nw(e10) {
        if (e10.nextUrl.pathname.match(/^\/(en|hi)\/dashboard/)) {
          ...
          if (t10) try {
            let e11;
            await nm(t10, (e11 = "u" > typeof process && process.env.JWT_SECRET || "nagrik_party_edge_secret_key_12345!@#", new TextEncoder().encode(e11)), { algorithms: ["HS256"] }), r10 = true;
          } catch (e11) {
          }
          if (!r10) {
      ...
      e.s(["config", 0, { matcher: ["/", "/(hi|en)/:path*"] }, "default", 0, nw], 96592);
      let nb = { ...e.i(96592) }, nE = "/middleware", nS = nb.middleware || nb.default;
      if ("function" != typeof nS) throw new class extends Error {
        constructor(e10) {
          super(e10), this.stack = "";
        }
      }(`The Middleware file "${nE}" must export a function named \`middleware\` or a default function.`);
      let nx = (e10) => tO({ ...e10, IncrementalCache: rd, incrementalCacheHandler: null, page: nE, handler: async (...e11) => {
        try {
          return await nS(...e11);
        } catch (a2) {
      ...
      async function nC(e10, t10) {
        let r10 = await nx({ request: { url: e10.url, method: e10.method, headers: T(e10.headers), nextConfig: { basePath: "", i18n: "", trailingSlash: false, experimental: { cacheLife: { default: { stale: 300, revalidate: 900, expire: 4294967294 }, seconds: { stale: 30, revalidate: 1, expire: 60 }, minutes: { stale: 300, revalidate: 60, expire: 3600 }, hours: { stale: 300, revalidate: 3600, expire: 86400 }, days: { stale: 300, revalidate: 86400, expire: 604800 }, weeks: { stale: 300, revalidate: 604800, expire: 2592e3 }, max: { stale: 300, revalidate: 2592e3, expire: 31536e3 } }, authInterrupts: false, clientParamParsingOrigins: [] } }, page: { name: nE }, body: "GET" !== e10.method && "HEAD" !== e10.method ? e10.body ?? void 0 : void 0, waitUntil: t10.waitUntil, requestMeta: t10.requestMeta, signal: t10.signal || new AbortController().signal } });
        return null == t10.waitUntil || t10.waitUntil.call(t10, r10.waitUntil), r10.response;
      }
      e.s(["default", 0, nx, "handler", 0, nC], 58217);
    }]);
  }
});
...
var BuildId = "U-LgalKnpUyeQAuszwt7o";
