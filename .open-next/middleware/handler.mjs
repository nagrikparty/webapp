...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      e.s(["config", 0, { matcher: ["/", "/(hi|en)/:path*"] }, "default", 0, nE, "runtime", 0, "experimental-edge"], 96592);
...
var BuildId = "Bbjg0VeaT6ABAXa0Yd9xG";
